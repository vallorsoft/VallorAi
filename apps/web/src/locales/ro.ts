...
export const ro = {
  ...
  editor: {
    ...
    openingsPanel: {
      title: 'Goluri (uși / ferestre)',
      empty: 'Peretele nu are goluri încă.',
      typeDoor: 'Ușă',
      typeWindow: 'Fereastră',
      widthLabel: 'Lățime (m)',
      heightLabel: 'Înălțime (m)',
      positionLabel: 'Poziție de la capăt (m)',
      sillLabel: 'Parapet (m)',
      addDoor: 'Adaugă ușă',
      addWindow: 'Adaugă fereastră',
      adding: 'Se adaugă...',
      deleteLabel: 'Șterge golul',
      lintelLabel: 'Buiandrug',
      lintelBearingNote: 'rezemare',
      positionError: 'Golul nu încape în perete la poziția dată.',
    },
    structuralPanel: {
      title: 'Structură',
      loading: 'Se încarcă datele structurale...',
      foundationTitle: 'Fundație (STAS 6054-77 / NP 112-2014)',
      depthLabel: 'Adâncime',
      widthLabel: 'Lățime talpă',
      concreteLabel: 'Beton',
      leanConcreteLabel: 'Beton de egalizare',
      reinforcementLabel: 'Armătură',
      transverseLabel: 'Bare de rezistență (transversale)',
      longitudinalLabel: 'Bare de repartiție (longitudinale)',
      stirrupLabel: 'Etrieri',
      coverLabel: 'Acoperire',
      depthUnverifiedNotice: 'Adâncimea de îngheț folosește valoarea maximă STAS pentru localități necitate — completați adresa terenului pentru o valoare specifică.',
      tieColumnsTitle: 'Stâlpișori (CR6-2013)',
      crossSectionLabel: 'Secțiune',
      categoryS1: 'S1 — colțuri/intersecții',
      categoryS2: 'S2 — intermediari',
      categoryS3: 'S3 — lângă goluri',
      centuriTitle: 'Centuri (CR6-2013)',
      countLabel: 'Număr',
      heightLabel: 'Înălțime',
      perWallNote: 'câte una pe fiecare perete portant, la fiecare nivel',
      engineerNotice: 'Valori constructive minime din standardele citate — trebuie confirmate de un inginer de structuri înainte de execuție.',
    },
    viewer3d: {

...
export const ro = {
  ...
  tasks: {
    ...
    markInProgress: 'Marchează în progres',
    deleteButton: 'Șterge',
    overdue: 'Depășit',
    toolTasks: 'Sarcini',
    loading: 'Se încarcă...',
  ...
  mep: {
    ...
    loading: 'Se încarcă instalațiile...',
    empty: 'Nicio cameră definită. Adaugă camere pentru a genera punctele de instalații.',
    regenerateButton: 'Regenerează instalații',
    regenerating: 'Se regenerează...',
    roomLabel: 'Cameră',
    unknownRoom: 'Cameră necunoscută',
    standardColumn: 'Standard',
    countColumn: 'Nr.',
    typeLabels: {
      WATER_SUPPLY: 'Apă rece',
      HOT_WATER_SUPPLY: 'Apă caldă',
      DRAIN: 'Scurgere',
      ELECTRICAL_OUTLET: 'Priză',
      SWITCH: 'Întrerupător',
      LIGHTING_POINT: 'Punct luminos',
    },
  },
  marketplace: {
    title: 'Marketplace',
    subtitle: 'Materiale de construcție de la producători verificați',
    allCategories: 'Toate categoriile',
    allSuppliers: 'Toți furnizorii',
    categoryLabel: 'Categorie',
    supplierLabel: 'Furnizor',
    noResults: 'Niciun material găsit',
    loading: 'Se încarcă...',
    unitPrice: 'Preț unitar',
    standardRef: 'Standard',
    priceUnverified: 'Preț neconfirmat',
    addToProject: 'Adaugă la proiect',
    selectProject: 'Selectează proiect',
    selectWall: 'Selectează perete',
    confirmAdd: 'Confirmă',
    addSuccess: 'Material adăugat la perete',
    categories: {
      BLOCK: 'Blocuri zidărie',
      INSULATION: 'Izolație',
      RENDER: 'Tencuială',
      FINISH: 'Finisaj',
      PAINT: 'Vopsea',
  ...
  admin: {
    ...
    statsHouses: 'Case',
    statsMaterials: 'Materiale',
    userEmail: 'Email',
    userName: 'Nume',
    userRole: 'Rol',
    userVerified: 'Verificat',
    userCreated: 'Înregistrat',
    changeRole: 'Schimbă rolul',
    roleSaved: 'Rol salvat',
    accessDenied: 'Acces refuzat — necesar rol SUPERADMIN',
    loading: 'Se încarcă...',
    navDashboard: 'Panou de control',
    navUsers: 'Utilizatori',
    navAiSettings: 'Setări AI',
    roles: {
      GUEST: 'Vizitator',
      USER: 'Utilizator',
      CLIENT: 'Client',
      ARCHITECT: 'Arhitect',
      STRUCTURAL_ENGINEER: 'Ing. structurist',
      MEP_ENGINEER: 'Ing. instalații',
      ELECTRICAL_ENGINEER: 'Ing. electric',
  ...
  floorPlanImport: {
    toolImport: 'Import plan',
    modalTitle: 'Import plan din imagine',
    modalSubtitle: 'Încarcă o fotografie sau scanare a planului de arhitectură. AI-ul va detecta camerele automat.',
    dropzone: 'Trage imaginea aici sau apasă pentru a selecta (JPEG, PNG, WebP)',
    dropzoneActive: 'Lasă imaginea...',
    importing: 'Se analizează planul...',
    success: 'Plan importat cu succes',
    error: 'Eroare la importul planului',
    close: 'Închide',
    importButton: 'Importă',
    roomsCreated: 'camere create',
  },
